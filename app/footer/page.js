...
import {
  ...
  ArrowRightIcon
} from "@heroicons/react/outline"; // ✅ Correct subpath
import {
  FaLinkedin,
  FaTwitter,
  FaFacebook,
      ...
      <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
        <div className="flex flex-col items-center md:items-start space-y-5">
          ...
          <div className="flex space-x-4">
            <a
              href="https://www.linkedin.com/company/settlesmart-solutions"
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={item.name}>
                <a
                  href={item.href}
                  className="text-gray-400 hover:text-white transition flex items-center group text-sm"
                >
