                                    ...
                                    <button
                                        ...
                                        className={`w-full text-left flex items-center justify-between p-4 rounded-xl transition-all ${
                                            activeSection === item.id
                                                ...
                                                : "bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-indigo-50 dark:hover:bg-gray-600 hover:text-indigo-700 dark:hover:text-white"
                                        }`}
                                    >
                            ...
                            {activeSection === "dispute" && (
                                <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <textarea
                                            rows={5}
                                            className="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-indigo-200 dark:focus:ring-indigo-700 focus:border-indigo-500 dark:focus:border-indigo-500 bg-white dark:bg-gray-700 dark:text-white"
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <label className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                                            ...
                                            <p className="text-xs text-gray-400 dark:text-gray-400 mt-1">PDF, DOC, JPG (Max 10MB each)</p>
                                    ...
                                    {assessmentResult && (
                                        <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 dark:border-blue-400 rounded-r-lg">
                                ...
                                <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="mb-8">
                                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-3">
                                            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Available Professionals</h3>
                                                ...
                                                >
                                                    <div className="flex items-start gap-4">
                                                        <div className="flex-shrink-0">
                                                            <div className="w-14 h-14 rounded-full bg-gray-200 dark:bg-gray-600 overflow-hidden relative">
                                                                <Image
                                                                    src={mediator.image}
                                                                    alt={mediator.name}
                                                                    fill
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="flex justify-between items-start">
                                                                <div>
                                                                    ...
                                                                    <p className="text-sm text-gray-600 dark:text-gray-300">{mediator.spec}</p>
                                                                </div>
                                                                <div className="flex items-center bg-yellow-50 dark:bg-yellow-900/20 px-2 py-1 rounded">
                                                                    ...
                                                                    <span className="ml-1 text-gray-800 dark:text-yellow-300 font-medium">{mediator.rating}</span>
                                                                </div>
                                                            </div>
                                    ...
                                    <div className="bg-blue-50 dark:bg-blue-900/20 p-5 rounded-xl border-l-4 border-blue-500 dark:border-blue-400">
                                ...
                                <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            <button
                                                ...
                                                className={`p-5 rounded-xl border-2 flex flex-col items-center transition-all ${
                                                    hearingType === "video"
                                                        ? "border-indigo-500 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 shadow-md"
                                                        : "border-gray-200 dark:border-gray-600 hover:border-indigo-300 dark:hover:border-indigo-500"
                                                }`}
                                    ...
                                    <div className="mb-8">
                                        ...
                                        <div className="relative">
                                            ...
                                            />
                                            <FiCalendar className="absolute right-4 top-4 text-gray-400 dark:text-gray-300" />
                                        </div>
                                    </div>
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                                {timeSlots.map((time) => (
                                                    <button
                                                        ...
                                                        className={`py-3 px-4 rounded-lg border-2 flex items-center justify-center transition-all ${
                                                            selectedTime === time
                                    ...
                                    <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-xl mb-8">
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex justify-between">
                                                <span className="text-gray-600 dark:text-gray-300">Dispute Type:</span>
                                                <span className="font-medium dark:text-white">{disputeType || "Not selected"}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-gray-600 dark:text-gray-300">Resolution Method:</span>
                                                <span className="font-medium dark:text-white">{assessmentResult || "Not assessed"}</span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-gray-600 dark:text-gray-300">Selected Mediator:</span>
                                                <span className="font-medium dark:text-white">
                                                    {selectedMediator ? mediators.find(m => m.id === selectedMediator).name : "Not selected"}
                                                </span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-gray-600 dark:text-gray-300">Hearing Date:</span>
                                                <span className="font-medium dark:text-white">
                                                    {selectedDate ? formatDate(selectedDate) : "Not scheduled"} {selectedTime && `at ${selectedTime}`}
                                                </span>
                                            </div>
                                            <div className="flex justify-between">
                                                <span className="text-gray-600 dark:text-gray-300">Hearing Mode:</span>
                                                <span className="font-medium dark:text-white capitalize">{hearingType === "video" ? "Video Conference" : "Text-Based"}</span>
                                            </div>
                                        </div>
                                    </div>
