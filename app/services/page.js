...
const serviceData = [
  ...
  },
  {
    ...
    icon: <FaBalanceScale className="text-4xl text-indigo-500" />,
            ...
            {serviceData.map((service, index) => (
              ...
              >
                          ...
                          <div className="bg-white/50 p-4 rounded-lg">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {service.features.map((feature, i) => (
                                <span key={i} className="px-3 py-1 bg-white text-sm rounded-full shadow-sm">
                                  {feature}
                                </span>
                              ))}
                            </div>
                ...
                <button 
                  ...
                  className="mt-auto px-6 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full hover:from-blue-600 hover:to-blue-700 transition-all flex items-center justify-center gap-2 w-full"
                >
                  {expandedCard === index ? (
                    <>
