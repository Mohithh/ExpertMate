...
// Note: Make sure to replace the Google Maps embed link with your actual office location.
// Also, ensure that the API key is set in your environment variables for the Google Maps API to work.
// You can also customize the icons and styles as per your design requirements.