...
const serviceData = [
  {
    ...
    features: ["Felony and misdemeanor defense", "White collar crimes", "DUI/DWI cases", "Appeals process"],
  ...
  },
  {
    ...
    features: ["Mergers & acquisitions", "Corporate governance", "Contract drafting", "Regulatory compliance"],
  ...
  },
  {
    ...
    features: ["Divorce mediation", "Child custody", "Prenuptial agreements", "Adoption services"],
  ...
  },
  {
    ...
    features: ["Title searches", "Closing services", "Landlord/tenant disputes", "Zoning issues"],
  ...
  },
  {
    ...
    features: ["Auto accidents", "Workplace injuries", "Medical malpractice", "Wrongful death"],
    stats: "$50M+ recovered",
  },
  {
    ...
    features: ["HIPAA compliance", "Licensing issues", "Medical partnerships", "Fraud defense"],
...
const Services = () => {
  ...
  const handleConsultClick = () => {
    ...
    if (!user) {
      ...
      window.open("https://cal.com/settlesmart/schedule-meeting", "_blank");
    }
  };
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {serviceData.map((service, index) => (
                <div
                  key={index}
                  className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-md overflow-hidden transition-all hover:shadow-xl hover:-translate-y-2 duration-300"
                >
                  <div className="p-8">
                    {service.icon}
