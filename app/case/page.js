...
const serviceData = [
  {
    ...
    icon: <FaGavel className="w-12 h-12 mx-auto mb-5 text-blue-600" />,
  ...
  {
    title: "Corporate Law",
    icon: <FaHandshake className="w-12 h-12 mx-auto mb-5 text-blue-600" />,
  ...
  {
    title: "Family Law",
    icon: <MdFamilyRestroom className="w-12 h-12 mx-auto mb-5 text-blue-600" />,
  ...
  },
  {
    ...
    icon: <FaHome className="w-12 h-12 mx-auto mb-5 text-blue-600" />,
  ...
  },
  {
    ...
    icon: <FaUserInjured className="w-12 h-12 mx-auto mb-5 text-blue-600" />,
  ...
  },
  {
    ...
    icon: <FaBriefcaseMedical className="w-12 h-12 mx-auto mb-5 text-blue-600" />,
      ...
      <section className="bg-white text-gray-900 py-20 px-5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <span className="text-blue-600 font-medium mb-2 block">OUR PRACTICE AREAS</span>
          ...
          {/* Stats Banner */}
          <div className="bg-blue-50 rounded-xl p-6 mb-16 grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {serviceData.map((service, index) => (
              <div
                key={index}
                className="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden transform transition-all hover:shadow-lg hover:-translate-y-2 duration-300"
              >
                <div className="p-8">
                  {service.icon}
                  ...
                  <div className="mb-6">
                    <h4 className="font-semibold text-blue-600 mb-3 text-sm uppercase tracking-wider">Key Services</h4>
                  ...
                  <div className="bg-blue-50 rounded-lg p-3 text-center">
                    <span className="text-sm font-medium text-blue-600">{service.stats}</span>
                  </div>
                </div>
          ...
          <div className="mt-20 bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl shadow-xl overflow-hidden">
            <div className="p-10 text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a
                  href="tel:+1234567890"
                  className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 font-medium px-8 py-3 rounded-md transition-colors duration-300"
                >
